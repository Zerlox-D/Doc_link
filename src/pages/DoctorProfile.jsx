...
export default function DoctorProfile() {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      const profileRes = await fetch(`https://doc-link.kesug.com/php/GetDoctorWithAvailability.php?id=${doctorId}`, { signal: controller.signal });
      ...
      const apptRes = await fetch(`https://doc-link.kesug.com/php/GetDoctorAppointments.php?doctor_id=${doctorId}`, { signal: controller.signal });
      ...
      const pendingRes = await fetch(`https://doc-link.kesug.com/php/GetDoctorPendingAppointments.php?doctor_id=${doctorId}`);
  ...
  try {
    const response = await fetch('https://doc-link.kesug.com/php/UpdateAppointmentStatus.php', {
      method: 'POST',
  ...
  try {
    const response = await fetch(
      `https://doc-link.kesug.com/php/GetDoctorAppointments.php?doctor_id=${doctorId}&type=completed`
    );
    const data = await response.json();
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const doctorRes = await fetch('https://doc-link.kesug.com/php/UpdateDoctorProfile.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          doctor_id: doctorId,
      ...
      const availRes = await fetch('https://doc-link.kesug.com/php/UpdateDoctorAvailability.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          doctor_id: doctorId,
